...
#define u8 uint8_t //fixed type size
#define u32 uint32_t //fixed type size
#define u64 uint64_t //fixed type size
...
static uf20bs hitag2bs_round(uf20bs *x)
{
    ...
    y = x[0] ^ x[2] ^ x[3] ^ x[6] ^ x[7] ^ x[8] ^ x[16] ^ x[22] ^ x[23] ^ x[26] ^ x[30] ^ x[41] ^ x[42] ^ x[43] ^ x[46] ^ x[47];
